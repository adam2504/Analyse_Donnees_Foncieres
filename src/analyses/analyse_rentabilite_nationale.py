"""
Rentabilité Nationale Analysis Module
====================================
...
def telecharger_et_extraire_dvf(
    ...
    prix_min=1000,
    prix_max=100000,
    output_file=str(project_root / "data" / "dvf_appartements_nettoye.csv")
):
    """
...
def calculer_prix_achat_par_ville(df_clean, output_file=str(project_root / "data" / "classement_prix_m2_par_ville.csv")):
...
def visualiser_prix_achat(stats_villes, df_clean, output_file=str(project_root / "outputs" / "classement_prix_m2_villes.png")):
...
def extraire_loyers(
    ...
    dossier_extraction = str(project_root / "data" / "data_loyer")
...
def visualiser_loyers(df_loyers, output_file=str(project_root / "outputs" / "classement_loyers_villes.png")):
...
def calculer_rentabilite(
    fichier_achat=str(project_root / "data" / "dvf_appartements_nettoye.csv"),
    fichier_loyers=str(project_root / "data" / "loyers_moyens_par_ville.csv"),
...
def visualiser_rentabilite(df_rentabilite, output_file=str(project_root / "outputs" / "analyse_rentabilite_finale.png")):
...
def analyse_rentabilite_nationale(
    villes=None,
    surface_max=45,
    prix_min=1000,
    prix_max=100000
    ...
    """
    Fonction principale qui exécute l'analyse complète de rentabilité nationale.
    ...
    print("\n")
    print("="*80)
    print("ANALYSE COMPLÈTE DE RENTABILITÉ NATIONALE")
