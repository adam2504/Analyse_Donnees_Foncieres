...
def create_rent_evolution_plot(df_grouped, output_file=None):
    ...
    plt.title("Evolution of average rent per m² (1 room) - Bordeaux vs Rennes (2020–2024)")
    plt.xlabel("Year")
...
def print_market_analysis():
    ...
    """
    print("\n======================  CHOICE CONTEXT  ====================== :\n")
    print("After analyzing major French cities, two stand out for Léa: Rennes and Bordeaux.")
    print("We will compare their rent evolution to determine which one best meets her needs.")
    print("Namely, rapid profitability, market stability, and low vacancy risk.\n")

    print("\n======================  ANALYSIS AND INTERPRETATION  ====================== :\n")
    print("Between 2020 and 2024, rents increased by about 9% in both Bordeaux and Rennes.")
    print("In 2024: 16.3 €/m² in Bordeaux vs 15.9 €/m² in Rennes.")
    print("Two similar curves: regular progression, tight market in both cities.")
    print()
    print("Bordeaux: higher rents, higher purchase costs, more competitive market.")
    print("Rennes: more accessible market, stable, strong student demand, lower vacancy risk.")
    print()
    print("Moreover, as seen previously, the average profitability is slightly higher in Rennes (2.98% vs 2.31%).")
    print()
    print("Conclusion: Rennes combines moderate rents, stability, and correct returns —")
    print("a safer and more coherent choice for Léa.")
